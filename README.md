...
## Nhánh build
- Khi push code lên nhánh build, github action sẽ chạy luồng **Flutter Android build** tự động build file app-release.apk. Xem trong Actions > Flutter Android build > workflow mới nhất > Artifacts để download về.
